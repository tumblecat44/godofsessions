...
```bash
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs wait --role heading --name "Start with GitHub."
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs click --role button --name "Ask Morrow"
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs absent --role button --name "Ask Morrow"
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs text
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs screenshot --name after-click
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs aria --name after-click
```
...
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs launch
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs doctor
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs drive github-identity-gate
node .grok/skills/verify-god-of-sessions/scripts/gos-verify.mjs cleanup
```
