...
- **Speak the revision.** Run `node .grok/skills/verify-god-of-sessions/scripts/drive.mjs morrow-revise`. Fill the composer with `the first overnight isn't important, deadline in 2 weeks, recommend something else.` Submit.
