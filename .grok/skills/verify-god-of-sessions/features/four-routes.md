...
- **Scan the three surfaces.** Run `node .grok/skills/verify-god-of-sessions/scripts/drive.mjs four-routes`. Morrow cards, Overnight cards, and Settings CLI cards mention only Claude Code, Codex, Grok Build, and Pi Agent as workers.
