...
const copy: Record<Language, Copy> = {
  ...
  ko: {
    ...
    heroPromise: "오늘의 에이전트 작업. <strong>하나의 승인된 야간 포트폴리오.</strong>",
    heroSupport:
      "Morrow는 Codex, Claude Code, Grok Build, Cursor, Pi Agent, Hermes, OpenClaw의 일을 편집 가능한 하나의 포트폴리오로 모읍니다. 한 번 승인하고, 아침에 항목별 결과를 확인하세요.",
    primaryCta: "Mac용 다운로드",
    secondaryCta: "22초 실제 시연 보기",
    heroTrust: "모든 항목을 직접 편집 · 정확한 포트폴리오 한 번 승인 · 아침에 결과별 근거 확인",
    proofEyebrow: "실제 제품 · 22초",
    proofNote:
      "컨셉 UI가 아닙니다. 실제 영문 제품 화면을 사용했으며, 번들 픽스처 데이터는 명확히 표시했습니다.",
    videoFallback: "공개 릴리스를 위한 합성 제품 시연 자료를 준비하고 있습니다.",
    proofControlLabel: "결정 장면으로 이동",
    chapterOne: "오늘의 미완료 작업 모으기",
    chapterTwo: "에이전트 포트폴리오 편집",
    chapterThree: "정확한 포트폴리오 한 번 승인",
    ...
    thesisQuote:
      "Morrow는 그 운영 부담을 당신이 고르는 하나의 잠들기 전 포트폴리오로 바꿉니다.",
    systemEyebrow: "추천 → 편집 → 승인 → 검토",
    systemTitle: "하나의 포트폴리오.<br />모든 항목을 빠짐없이.",
    decisionOneEyebrow: "포트폴리오 고르기",
    decisionOneTitle: "추천마다 유지하고, 빼고, 질문할 수 있습니다.",
    decisionOneBody:
      "Morrow는 오늘의 미완료 작업을 모으고 관련 세션을 함께 묶습니다. 각 항목이 실행 가능하거나, 답이 필요하거나, 제외되는 이유를 보여줍니다.",
    decisionTwoEyebrow: "한 번 승인하기",
    decisionTwoTitle: "정확한 항목, 에이전트, 작업 경계를 한 번 승인합니다.",
    decisionTwoBody:
      "준비된 에이전트와 당신이 남긴 일만 야간 포트폴리오에 들어갑니다. 승인한 항목, 프로젝트 경계, 아침 마감은 그대로 유지됩니다.",
    ...
    boundaryTitle: "포트폴리오를 편집하고.<br /><em>한 번 승인하세요.</em>",
    boundaryBody:
      "남길 추천을 고르고, 각 에이전트의 준비·설정 필요·차단 상태를 확인한 뒤 정확한 항목, 프로젝트 경계, 시간 범위를 승인하세요. 하나라도 바뀌면 새 승인을 받습니다.",
    specRoute: "항목",
    specWorkspace: "에이전트",
    specPermission: "프로젝트 경계",
    specNetwork: "허용한 변경",
    specBudget: "최대 시간 범위",
    specDeadline: "아침 마감",
    specFooter: "한 항목이라도 바뀌면 → 다시 승인합니다.",
    supportEyebrow: "로컬 준비 상태를 정직하게",
    supportTitle: "일곱 에이전트.<br />각각의 로컬 상태.",
    supportIntro:
      "Orchestrate는 각 에이전트를 실행 가능한 포트폴리오에 넣기 전에 이 Mac에서 준비 상태를 확인하고, 그 이유를 함께 보여줍니다.",
    providerColumn: "에이전트",
    discoverColumn: "포트폴리오",
    ...
    supportFootnote:
      "표에 있다는 이유만으로 바로 실행되지는 않습니다. 로컬 설치, 로그인, 안전한 작업 접근이 확인되어야 준비 상태가 됩니다. 설정 필요나 차단 상태는 Orchestrate에서 이유를 함께 보여줍니다.",
    ...
    noteThree:
      "추천 포트폴리오를 먼저 편집할 수 있습니다. 한 번의 만료되는 승인 뒤에도 정확히 고른 항목과 에이전트만 시작합니다.",
    faqTitle: "잠들기 전 짧은 답.",
    faqOneQuestion: "또 다른 코딩 에이전트인가요?",
    faqOneAnswer:
      "아니요. Morrow는 Codex, Claude Code, Grok Build, Cursor, Pi Agent, Hermes, OpenClaw를 하나의 야간 포트폴리오로 조율합니다. 선택된 에이전트는 각자의 실행 근거를 남깁니다.",
    faqTwoQuestion: "묻지 않고 실행하나요?",
    faqTwoAnswer:
      "추천 항목을 먼저 직접 편집합니다. 한 번 승인한 정확한 포트폴리오만 실행할 수 있고, 그 승인은 만료됩니다.",
    ...
    footerCopy: "오늘 밤의 에이전트 작업. 하나의 승인된 포트폴리오. 아침의 근거.",
  },
};
