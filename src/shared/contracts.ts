...
export interface OvernightPortfolioCandidateSummary {
  ...
  outcome?: string;
  verification?: string;
  preferredProvider: "auto" | OvernightProvider;
...
export interface OvernightPortfolioEditInput {
  ...
  providerByItem?: Partial<Record<string, OvernightProvider>>;
}
...
export interface BootstrapState {
  rootName: string;
  /** Exact folder that bounds file work for this app installation. */
  rootPath: string;
