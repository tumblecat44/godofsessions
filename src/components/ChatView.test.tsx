...
describe("Morrow first-use conversation", () => {
  it("explains conversation-first tool behavior without a project picker", () => {
    render(<ChatView state={state} onNew={vi.fn()} onOpen={vi.fn()} onSend={vi.fn()} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={vi.fn()} onStartOvernight={vi.fn()} />);
  ...
  it("turns runtime failures into a friendly Morrow scene", () => {
    render(<ChatView state={state} error="Model connection slipped." onNew={vi.fn()} onOpen={vi.fn()} onSend={vi.fn()} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={vi.fn()} onStartOvernight={vi.fn()} />);
  ...
  it("keeps an existing transcript visible beside a friendly error", () => {
    render(<ChatView state={state} error="Connection slipped." conversation={{ id: "one", title: "Kept", thinkingLevel: "medium", busy: false, messages: [{ id: "u", role: "user", parts: [{ type: "text", text: "Please keep this visible." }] }] }} onNew={vi.fn()} onOpen={vi.fn()} onSend={vi.fn()} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={vi.fn()} onStartOvernight={vi.fn()} />);
  ...
  it("blocks keyboard submission without a model and routes directly to settings", () => {
    ...
    render(<ChatView state={{ ...state, language: "ko" }} onNew={vi.fn()} onOpen={vi.fn()} onSend={onSend} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={onOpenSettings} onStartOvernight={vi.fn()} />);
  ...
  it("submits with Enter once a connected model is available", () => {
    ...
    render(<ChatView state={connectedState} onNew={vi.fn()} onOpen={vi.fn()} onSend={onSend} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={vi.fn()} onStartOvernight={vi.fn()} />);
  ...
  it("offers the Pi minimal and max thinking levels for reasoning models", () => {
    ...
    render(<ChatView state={reasoningState} onNew={vi.fn()} onOpen={vi.fn()} onSend={vi.fn()} onAbort={vi.fn()} onApproval={vi.fn()} onModel={vi.fn()} onThinking={vi.fn()} onOpenSettings={vi.fn()} onStartOvernight={vi.fn()} />);
