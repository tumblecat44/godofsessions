  ...
  return (
    <div className="morrow-empty">
      ...
      <div>
        ...
        <p>{ko ? "그냥 이야기해도 좋아요. 파일이나 명령은 부탁할 때만 사용하고, 바꾸기 전에는 먼저 물어볼게요. 다른 AI 세션을 바탕으로 밤사이 작업을 준비하려면 Overnight 관리에서 직접 시작하세요." : "You can simply talk. I only reach for files or commands when you ask—and I pause before changing anything. Open Orchestrate when you want to prepare overnight work from other AI sessions."}</p>
