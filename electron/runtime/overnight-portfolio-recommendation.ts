...
export type OvernightProviderId = "codex" | "claude" | "grok" | "cursor" | "pi" | "hermes" | "openclaw";
...
const providerOrder: OvernightProviderId[] = ["codex", "claude", "grok", "cursor", "pi", "hermes", "openclaw"];
